...
- [ArrayList<E>](https://docs.oracle.com/javase/7/docs/api/java/util/ArrayList.html): a diferença entre um array embutido e um ArrayListem Java, é que o tamanho de um array não pode ser modificado (se você quiser adicionar ou remover elementos de/para um array, você tem que criar um novo). Enquanto os elementos podem ser adicionados e removidos de um ArrayListsempre que você quiser. É possível adicionar ou remover elemento de qualquer lugar, exceto o final, que exigirá a troca de todos os últimos elementos. Além disso, se você adicionar mais elementos do que a capacidade, a matriz antiga será copiada para a nova matriz criada (não é recomendado adicionar em um ArrayList). Possui índice, iterar sobre um ArrayList é tecnicamente mais rápido do que um LinkedList. [Quando usar o LinkedList sobre o ArrayList em Java?](https://qastack.com.br/programming/322715/when-to-use-linkedlist-over-arraylist-in-java)
...
- [NavigableSet](https://docs.oracle.com/javase/7/docs/api/java/util/TreeSet.html): ele adiciona características que o TreeSet não possui, para inserir um elemento no TreeSet precisa implementar a interface Comparable ou passar o Comparator no construtor do TreeSet. Vantagens do TreeSet: os elementos já vem ordenados na inserção.
- [HashMap](https://www.devmedia.com.br/hashmap-java-trabalhando-com-listas-key-value/29811): trabalha com o conceito de key-value pairs, ou seja, cada elemento de sua lista possui uma chave e valor associado, assim podemos realizar uma busca rápida pela chave que desejamos, sem precisar percorrer toda lista ou saber o index/posição que desejamos consultar.
