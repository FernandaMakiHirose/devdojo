...
- [Busca binária](): retorna o índice do elemento encontrado no método `containsAll()`, enquanto sem busca binária o método retorna `true` ou `false`.
...
- [LinkedHashSet](): mantém a ordem de inserção, é mais lento que o HashSet, não permite elementos duplicados, não possui índice.
